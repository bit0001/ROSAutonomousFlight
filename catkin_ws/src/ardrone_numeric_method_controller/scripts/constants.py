...
from util import get_array_from_file
...
T0 = 0.1
TP = 2 * T0
K_V_XY = get_array_from_file(PATH_TO_REFERENCES + "control_constants.txt")[0]
K_V_Z = get_array_from_file(PATH_TO_REFERENCES + "control_constants.txt")[1]
K_OMEGA_PSI = get_array_from_file(PATH_TO_REFERENCES + "control_constants.txt")[2]
V_XY_MAX = 2.0
V_Z_MAX = 2.0
OMEGA_PSI_MAX = 2.0
